...
HD_PWD='C:/Users/liqingyan/vivado_test/test_traffic/test_traffic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TrafficBoy.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TrafficBoy.tcl -notrace
