...
HD_PWD='C:/Users/liqingyan/vivado_test/test_traffic/test_traffic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TrafficBoy.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TrafficBoy.tcl
